 ...
 */
package zookeeper.zookeeper.function.distributedlock.test;
...
import zookeeper.zookeeper.function.distributedlock.LockListener;
import zookeeper.zookeeper.function.distributedlock.WriteLock;
...
public class WriteLockTest extends ClientBase {
    ...
    protected void runTest(int count) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            ZooKeeper keeper = createClient("123.206.13.151:2181");
